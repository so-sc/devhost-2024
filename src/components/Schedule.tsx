...
const scheduleData = [
  {
    ...
    events: [
      ...
      },
      {
        ...
        description: "Become the ultimate agent in our Valorant competition!",
        speaker: "",
        type: "Competition",
      },
      {
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        description: "Put your web design chops to the test!",
        speaker: "",
        type: "Competition",
      },
      {
      ...
      },
      {
        ...
        description: "The thrill of victory awaits—are you ready to conquer",
        speaker: "",
        type: "Competition",
      },
      {
